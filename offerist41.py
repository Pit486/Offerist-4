...
def load_data():
    ...
    print(a)
        ...
        #print(temp_d)
            #trow = row.split(',')
            #if trow[2].replace('"', '').replace("'", '').replace('\n', '').isdigit and trow[3].replace('"', '').replace("'", '').replace('\n', '').isdigit:
                #row = trow[0] + ',' + trow[1] + trow[2] + '.' + trow[3] + ',\n'
                #print(row)
            #if len(row.split(',')) < 4:
                #row = row.replace('\n', ',\n')
            #print(row)
            #temp_d.append(row.split(','))
    #print(temp_d)
